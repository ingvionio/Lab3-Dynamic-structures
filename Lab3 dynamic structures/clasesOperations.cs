...
namespace Lab3_dynamic_structures
{
    ...
    class Plus : Operation
    {
        ...
        public override Number Execute(params Number[] numbers)
        {
            ...
            return new Number { Value = num2.Value + num1.Value };
        }
    }
    ...
    class Power : Operation
    {
        ...
        public override Number Execute(params Number[] numbers)
        {
            ...
            return new Number { Value = Math.Pow(num2.Value, num1.Value) };
        }
    }
    ...
    class Root : Operation
    {
        ...
        public override Number Execute(params Number[] numbers)
        {
            ...
            return new Number { Value = Math.Pow(num2.Value, 1 / num1.Value) };
        }
    }
